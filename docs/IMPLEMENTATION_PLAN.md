...
- **Tasks**:
  ...
  2. Setup code quality tools (ESLint, Prettier, Husky).
  3. Define the Tailwind design tokens (near-black background, charcoal surfaces, muted gray text, green/blue accents).
  4. Configure `next/font` with the chosen typography (e.g., Inter or a refined sans-serif/mono pairing).
...
- **Tasks**:
  ...
  2. Build the Homepage Hero component (Left-aligned PFP, Professional positioning, Social links).
  3. Implement responsive stacking for mobile views.
